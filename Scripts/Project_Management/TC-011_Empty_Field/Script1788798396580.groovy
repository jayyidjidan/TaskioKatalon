...
WebUI.click(findTestObject('Page_Laravel/button_Add Project'))

WebUI.click(findTestObject('Page_Laravel/button_Save (2)'))

WebUI.click(findTestObject('Page_Laravel/p_The nama proyek field is required'))

WebUI.assertElementText(findTestObject('Page_Laravel/p_The nama proyek field is required'), 'The nama proyek field is required.', 
    0)
